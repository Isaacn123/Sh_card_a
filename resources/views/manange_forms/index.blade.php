...
<!-- <link rel="stylesheet" href="{{ asset('forms/css/bootstrap.min.css')}}"> -->
@section('content')
...
<div class="container container_width" id="form-field">
    <form id="form-data">
        <div class="row">
        ...
        <div>
            ...
            <div class="row align-items-center d-flex">
                            <div class="col-sm-8">
                                <p class="question-text m-0" style="font-size: 20px !important;" contenteditable="false" title="Select a Training Group">Select a Training Group</p>
                            </div>
                            <div class="col-sm-4">
                                <select id="mySelectBox" autofocus required title="question choice type" name="trainings" class='form-control choice-options'>
                                <option value="" selected disabled> --- choose Training --- </option> 

                                    @foreach($trainings as $training)
                                    <option id="mySelectBox"  value="{{$training->id}}">{{$training->training_name}}</option>
                                    @endforeach
        ...
        <div class="d-flex w-100 justify-content-center" id="form-buidler-action">
            ...
            <button class="btn btn-default border ml-1" type="submit" id="save_form"><i class="fa fa-save"></i> Save Form</button>
        </div>
    </form>
</div>
...
<div class="card mt-3 mb-3 col-md-12 question-item ui-state-default" data-item="0">
    ...
    <div class="card-body">
        ...
        <div class="row ">
            <div class="form-group choice-field col-md-12">
                <textarea name="message" class="form-control col-sm-12" cols="30" rows="5" placeholder="Write your answer here"></textarea>
            </div>
        </div>
    </div>
    <div class="card-footer">
